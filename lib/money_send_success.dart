...
class Transferconfirm2 extends StatefulWidget {
  final String a, b, c;
  final double d;
  ...
  @override
  State<Transferconfirm2> createState() => _Transferconfirm2State();
}

class _Transferconfirm2State extends State<Transferconfirm2> {
