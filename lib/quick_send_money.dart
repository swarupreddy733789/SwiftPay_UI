...
class QuickSendMoney extends StatefulWidget {
  final String name, account;
  const QuickSendMoney({super.key, required this.name, required this.account});

  @override
  State<QuickSendMoney> createState() => _QuickSendMoneyState();
}

class _QuickSendMoneyState extends State<QuickSendMoney> {
  ...
  void initState() {
    super.initState();
    _controller1 = TextEditingController(text: widget.account);
    _controller2 = TextEditingController();
    _controller3 = TextEditingController(text: widget.name);
  }
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        Verify(a: a, b: b, c: c, d: d, e: false),
                  ),
                );
              },
              child: Text(
